            ...
            <div className="panel-shell">
                <header className="panel-header">
                    ...
                    <p className="panel-subtitle">
                        Shared styling playground. Tune tokens/classes in `packages/shared/src/globals.css` and validate all component families here.
                    </p>
                </header>
                ...
                <section className="ui-grid-2">
                    ...
                    <div className="ui-card">
                        ...
                        <label className="ui-label" htmlFor="display-name">Display name</label>
                        <input id="display-name" className="ui-input" placeholder="Practice Dashboard" />
                        ...
                        <textarea id="notes" className="ui-input min-h-24 resize-y" placeholder="Any setup notes..." />
                    </div>
                </section>
                ...
                <section className="ui-grid-2">
                    <div className="ui-card">
                        ...
                        <div className="space-y-3 text-sm">
                            <label className="flex items-center gap-2">
                                <input type="checkbox" className="h-4 w-4 rounded border-input bg-background" defaultChecked />
                                Enable recording
                            </label>
                            <label className="flex items-center gap-2">
                                <input type="radio" name="team" className="h-4 w-4 border-input bg-background" defaultChecked />
                                Team A
                            </label>
                            <label className="flex items-center gap-2">
                    ...
                    <div className="ui-card">
                        ...
                        <label className="ui-label" htmlFor="smooth">Smoothing</label>
                        <input id="smooth" type="range" min={0} max={100} defaultValue={64} className="ui-range" />
                        ...
                        <div className="mt-5 grid grid-cols-3 gap-2 text-xs">
                            <div className="rounded-md border border-border p-2 text-center">Low</div>
                            <div className="rounded-md border border-border p-2 text-center bg-secondary text-secondary-foreground">Medium</div>
                            <div className="rounded-md border border-border p-2 text-center">High</div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="ui-card">
                        ...
                        <div className="space-y-2">
                            <div className="ui-alert ui-alert-info">
                                ...
                                <div className="ui-alert-desc">Telemetry stream connected successfully.</div>
                            </div>
                            <div className="ui-alert ui-alert-success">
                                <div className="ui-alert-title">Success</div>
                                <div className="ui-alert-desc">Robot profile synced and validated.</div>
                            </div>
                            <div className="ui-alert ui-alert-warning">
                                <div className="ui-alert-title">Warning</div>
                                <div className="ui-alert-desc">Packet latency has increased to 48ms.</div>
                            </div>
                            <div className="ui-alert ui-alert-error">
                                <div className="ui-alert-title">Error</div>
                                <div className="ui-alert-desc">Driver station disconnected unexpectedly.</div>
                            </div>
                            <div className="rounded-md border border-border bg-card p-3 text-sm">
                                <div className="font-medium">Toast Preview</div>
                                <div className="text-muted-foreground">Saved layout settings.</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table className="ui-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Battery</td>
                                    <td>12.4V</td>
                                    <td><span className="ui-badge ui-badge-success">Nominal</span></td>
                                </tr>
                                <tr>
                                    <td>Loop Time</td>
                                    <td>18ms</td>
                                    <td><span className="ui-badge ui-badge-info">Good</span></td>
                                </tr>
                                <tr>
                                    <td>IMU Drift</td>
                                    <td>0.5deg</td>
                                    <td><span className="ui-badge ui-badge-warning">Watch</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <section className="ui-grid-2">
                    <div className="ui-card">
                        ...
                        <div className="ui-chart-bars mb-4">
                            ...
                            <div className="ui-chart-bar" style={{ width: '54%', backgroundColor: 'hsl(var(--chart-2))' }} />
                            <div className="ui-chart-bar" style={{ width: '68%', backgroundColor: 'hsl(var(--chart-3))' }} />
                            <div className="ui-chart-bar" style={{ width: '40%', backgroundColor: 'hsl(var(--chart-4))' }} />
                        </div>
                        <svg viewBox={`0 0 ${chartWidth} ${chartHeight}`} className="w-full h-52 rounded-md border border-border bg-zinc-950">
                            {yTicks.map((tick) => {
                            ...
                            <line x1={padLeft} y1={padTop} x2={padLeft} y2={chartHeight - padBottom} stroke="hsl(var(--muted-foreground) / 0.6)" strokeWidth="1" />
                            <line
                                x1={padLeft}
                            ...
                            <text x={chartWidth / 2} y={chartHeight - 4} textAnchor="middle" fontSize="11" fill="hsl(var(--muted-foreground))">
                                Time
                            </text>
                            <text
                                x={12}
                    ...
                    <div className="ui-card">
                        ...
                        <p className="mt-3 text-xs text-muted-foreground">Pie and donut previews for category distributions.</p>
                    </div>
                </section>
                ...
                <section className="ui-card">
                    ...
                    <div className="flex flex-wrap gap-2 text-sm">
                        ...
                        <span className="ui-badge ui-badge-outline">Dialog/Sheet/Drawer</span>
                    </div>
                </section>

                <section className="ui-card">
                    <h2 className="ui-card-title">Official Shadcn Component Registry Coverage</h2>
                    <p className="text-sm text-muted-foreground mb-3">
                        Full list from shadcn components docs. Use this as your implementation checklist for production panels.
                    </p>
                    <div className="flex flex-wrap gap-2">
